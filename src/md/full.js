...
/* THIS FILE WAS AUTO-GENERATED USING CATALOG EXPORTER; YOU SHOULD NOT EDIT THIS FILE; GENERATE TIME: 2021-07-27T09:37:49.178Z; */
...
/**
 * Metric Title: PCF
 * Metric ID: aaArPim7chwP
 * Metric Type: MAQL Metric
 */

export const PCF = newMeasure(idRef("aaArPim7chwP", "measure"));
/**
...
/**
 * Metric Title: test
 * Metric ID: ad4rCHxdiCwY
 * Metric Type: MAQL Metric
 */

export const Test = newMeasure(idRef("ad4rCHxdiCwY", "measure"));
/**
 * Fact Title: Amount
...
export const Amount = {
   ...
   */
  Sum: newMeasure(idRef("fact.orderlines.amount", "fact"), m =>
    m.aggregation("sum")
  ),
  /**
   * Fact Title: Amount
   ...
   */
  Avg: newMeasure(idRef("fact.orderlines.amount", "fact"), m =>
    m.aggregation("avg")
  ),
  /**
   * Fact Title: Amount
   ...
   */
  Min: newMeasure(idRef("fact.orderlines.amount", "fact"), m =>
    m.aggregation("min")
  ),
  /**
   * Fact Title: Amount
   ...
   */
  Max: newMeasure(idRef("fact.orderlines.amount", "fact"), m =>
    m.aggregation("max")
  ),
  /**
   * Fact Title: Amount
   ...
   */
  Median: newMeasure(idRef("fact.orderlines.amount", "fact"), m =>
   ...
   */
  Runsum: newMeasure(idRef("fact.orderlines.amount", "fact"), m =>
...
export const Price = {
   ...
   * Fact Aggregation: sum
   */
  Sum: newMeasure(idRef("fact.orderlines.price", "fact"), m =>
    m.aggregation("sum")
  ),
  /**
   * Fact Title: Price
   ...
   * Fact Aggregation: avg
   */
  Avg: newMeasure(idRef("fact.orderlines.price", "fact"), m =>
    m.aggregation("avg")
  ),
  /**
   * Fact Title: Price
   ...
   * Fact Aggregation: min
   */
  Min: newMeasure(idRef("fact.orderlines.price", "fact"), m =>
    m.aggregation("min")
  ),
  /**
   * Fact Title: Price
   ...
   * Fact Aggregation: max
   */
  Max: newMeasure(idRef("fact.orderlines.price", "fact"), m =>
    m.aggregation("max")
  ),
  /**
   * Fact Title: Price
   ...
   * Fact Aggregation: median
   */
  Median: newMeasure(idRef("fact.orderlines.price", "fact"), m =>
    m.aggregation("median")
  ),
  /**
   * Fact Title: Price
   ...
   * Fact Aggregation: runsum
   */
  Runsum: newMeasure(idRef("fact.orderlines.price", "fact"), m =>
    m.aggregation("runsum")
  )
};
/**
...
export const Quantity = {
   ...
   * Fact Aggregation: sum
   */
  Sum: newMeasure(idRef("fact.orderlines.quantity", "fact"), m =>
    m.aggregation("sum")
  ),
  /**
   * Fact Title: Quantity
   ...
   * Fact Aggregation: avg
   */
  Avg: newMeasure(idRef("fact.orderlines.quantity", "fact"), m =>
    m.aggregation("avg")
  ),
  /**
   * Fact Title: Quantity
   ...
   * Fact Aggregation: min
   */
  Min: newMeasure(idRef("fact.orderlines.quantity", "fact"), m =>
    m.aggregation("min")
  ),
  /**
   * Fact Title: Quantity
   ...
   * Fact Aggregation: max
   */
  Max: newMeasure(idRef("fact.orderlines.quantity", "fact"), m =>
    m.aggregation("max")
  ),
  /**
   * Fact Title: Quantity
   ...
   * Fact Aggregation: median
   */
  Median: newMeasure(idRef("fact.orderlines.quantity", "fact"), m =>
    m.aggregation("median")
  ),
  /**
   * Fact Title: Quantity
   ...
   * Fact Aggregation: runsum
   */
  Runsum: newMeasure(idRef("fact.orderlines.quantity", "fact"), m =>
    m.aggregation("runsum")
  )
};
/**
