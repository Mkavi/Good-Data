  ...
  return (
    <footer className={styles.Footer}>
      <section className={styles.FooterLinks}>
        <h3 className={styles.FooterLinksHeader}>
          Find more about GoodData.UI&nbsp;on
        </h3>
      ...
      <section className={styles.Copyright}>
        Copyright © 2007–<span>{new Date().getFullYear()}</span> GoodData
        Corporation. All Rights Reserved. Code licensed under a dual license
        <br />
        <a
          href="https://github.com/gooddata/gooddata-react-components/blob/master/LICENSE"
          className={styles.FooterLink}
        >
          CC BY-NC 4.0 for trial experience and GoodData.UI EULA for commercial
          use.
        </a>
      </section>
    </footer>
